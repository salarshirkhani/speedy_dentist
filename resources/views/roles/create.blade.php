            ...
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('roles.store') }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control ambitious-form-loading @error('name') is-invalid @enderror" name="name" id="name" type="text" placeholder="@lang('Role Name')" value="{{ old('name') }}" required>
                            @error('name')
                    ...
                    <div id="user_block">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label ambitious-center"><h4>@lang('Price') <b class="ambitious-crimson">*</b></h4></label>
                            <div class="col-md-8">
                                <input class="form-control ambitious-form-loading @error('price') is-invalid @enderror" name="price" id="price" type="text" placeholder="@lang('Role Price')" value="{{ old('price') }}">
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label ambitious-center"><h4>@lang('Validity') <b class="ambitious-crimson">*</b></h4></label>
                            <div class="col-md-8">
                                <input class="form-control ambitious-form-loading @error('validity') is-invalid @enderror" name="validity" id="validity" type="text" placeholder="@lang('Validity Day')" value="{{ old('validity') }}">
                                @error('validity')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
